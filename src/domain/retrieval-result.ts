 ...
 * handling says where not to look — and each of those has its own module with
 * its own concerns. Putting the envelope in any one of them would make that
 * one the home of a type the others keep adding to.
 *
 ...
 * `deadEndWarnings` is where it has already been shown not to lead — warning
 * material, never a prohibition.
 *
 ...
 * identical from here.
 */
export interface RetrievalMemoryCandidate extends RevalidatedMemoryCandidate {
